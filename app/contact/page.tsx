          ...
          <div className="flex flex-col lg:flex-row lg:justify-between gap-8 border-l-4 border-[#CFFF04] pl-5">
            ...
            <div className="flex-1 flex items-end">
              <p className="text-lg text-gray-700">
                Waarom zou je een app gebruiken die geld kost of een abonnement vereist,
                en toch niet helemaal doet wat je nodig hebt? Met vibecoding maak je een app
                of website op maat. Of liever: AI maakt die voor je.
              </p>
            </div>
...
noemenswaardige voorkennis aan zou kunnen beginnen.
              ...
              <p>
                Maar is dat zo? Wel: ja en nee
              </p>

              <p>
              Ja: een simpel programma, zoals een spelletje dat je in je
...
verleggen.
            ...
            {/* SUBSECTION */}
            <section className="flex flex-col gap-4">
              <h2 className="text-2xl font-bold">Een eenvoudig spel</h2>
...
met de extensie ‘.html’, bijvoorbeeld ‘Mijnspelletje.html’ op je computer.rde bijvoorbeeld: “Schrijf een spel waarbij een dinosaurus een bal moet
koppen.”
              </p>

              {/* STEPS FLEX BOX */}
              <div className="flex flex-col gap-3 bg-gray-50 p-4 rounded-lg border">
                <p className="font-semibold">Op een Windows-pc:</p>

                <div className="flex flex-col gap-2 text-sm">
                  <p>1) Klik op de code die de chatbot genereerde (meestal op het ‘copy’-knopje bovenaan
of onderaan)</p>
                  <p>2) Plak de code in een programma als Windows Kladblok of Macintosh TextEdit</p>
                  <p>3) Bewaar het bestand met een naam als ‘dinospel.html’</p>
                  <p>4) Klik op dinospel.html</p>
                  <p>5) Het spel opent in je standaardbrowser. En spelen maar!</p>
                </div>
              </div>
            </section>
...
een paar keer proberen.
            ...
            {/* QUOTE FLEX */}
            <div className="flex border-l-4 border-[#CFFF04] pl-4 italic text-gray-600">
              Je hoeft geen programmeur te zijn — maar je moet wel weten wat je wil bouwen.
            </div>

            {/* SECOND SECTION */}
            <section className="flex flex-col gap-4">
              <h2 className="text-2xl font-bold">Ambitieuzer: een gezinskalender</h2>
...
Supabase.
              ...
              <div className="flex border-l-4 border-[#CFFF04] pl-4 italic text-gray-600">
              Ik besliste uiteindelijk, alweer op advies van ChatGPT, om mijn programma niet altijd kunt terugkeren naar een eerdere, werkende versie.
            </div>
...
activiteit wel kon toevoegen maar niet kon wissen of wijzigen.
            ...
            {/* THIRD SECTION */}
            <section className="flex flex-col gap-4">
              <h2 className="text-2xl font-bold">Echt agentic werken</h2>
...
helR van die tijd in elkaar gestoken krijg.
            ...
            {/* THIRD SECTION */}
            <section className="flex flex-col gap-4">
              <h2 className="text-2xl font-bold">Voorkennis</h2>
...
maanden waarschijnlijk met twee-drie prompts genereren
        ...
        <aside className="w-full lg:w-80 flex flex-col gap-6">
          ...
          <div className="bg-black p-5 rounded-xl shadow-sm flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 text-sm text-white">
              ...
              <p className="hover:text-[#CFFF04] cursor-pointer">
                Beste AI tools voor coderen
              </p>
              <p className="hover:text-[#CFFF04] cursor-pointer">
                AI en de toekomst van development
              </p>
            </div>
          </div>
  ...
  <div className="relative aspect-square w-full max-w-xs mx-auto rounded-xl overflow-hidden border border-white/10 bg-white p-6 shadow-lg transition-all duration-300 group-hover:shadow-[0_0_25px_rgba(207,255,4,0.35)] group-hover:border-[#CFFF04]/50 group-hover:-translate-y-1">
  ...
  <p className="text-xs text-gray-400 uppercase tracking-widest mt-2 text-center">
    Advertentie
  </p>
