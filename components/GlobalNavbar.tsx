    ...
    <>
      ...
      <SidebarSlider isOpen={isSidebarOpen} onClose={() => setIsSidebarOpen(false)}>
        <nav className="flex flex-col space-y-4">
          ...
          <a href="/about" className="hover:underline">Artikel 1 </a>
          <a href="/contact" className="hover:underline">Artikel 2</a>
          <a href="/login" className="hover:underline">Artikel 3</a>
        </nav>
      </SidebarSlider>
    </>
  )
